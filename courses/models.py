...
class Block(models.Model):
    type = models.ForeignKey(TypeBlock, default=None, null=True, on_delete=models.SET_DEFAULT)
    course = models.ForeignKey(Course, default=None, null=True, on_delete=models.SET_DEFAULT)
